...
namespace Roushi
{
    ...
    public class ScreenManager
    {
        ...
        public static float ZDepth(int x) // Takes an x value and returns a float value associated to the integer. 1 is closest to screen
        {
            if (x <= 0)
                throw new System.ArgumentOutOfRangeException("The value of ZDepth must be greater than or equal to 0.");

            return x*((float)Math.Pow(10,-6));
        }
