...
namespace Roushi
{
    ...
    class DialogManager // Dialog Boxes Of All Sorts Go Here
    {
        ...
        {
            spriteBatch.Draw(foreground, Vector2.Zero, new Rectangle(0, 0, foreground.Width, foreground.Height), Color.White, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0.00000001f);
