...
namespace Roushi
{
    class Messagebox : Dialog
    {
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            {
                spriteBatch.Draw(finalRender, Vector2.Zero, new Rectangle(0, 0, (int)finalRender.Width, (int)finalRender.Height), Color.White, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0.0000000001f);
                if (textBox.doneDrawing && ShouldDraw)
                    ScreenManager.Instance.SpriteBatch.Draw(blinkerTexture, new Vector2(position.X + messageBoxTexture.Width - 20, position.Y + messageBoxTexture.Height - 20), new Rectangle(0, 0, (int)blinkerTexture.Width, (int)blinkerTexture.Height), new Color(255, 255, 255, blinkerAlpha), 0f, new Vector2((float)blinkerTexture.Width / 2, (float)blinkerTexture.Height / 2), 1f, SpriteEffects.None, 0.00000000001f);
