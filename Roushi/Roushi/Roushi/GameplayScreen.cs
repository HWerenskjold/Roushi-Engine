...
namespace Roushi
{
    public class GameplayScreen : Screen
    {
        ...
        public override void LoadContent()
        {
            ...
            entityManager.Add(EntityFactory.CreatePlayer(3, 1, 200, new Vector2(ScreenManager.Instance.Dimensions.X/2, 700), "GameObjects/templateMan", new Vector2(32, 32)));
            ...
            entityManager.Add(EntityFactory.CreateWorm(new Vector2(300, 600)));
